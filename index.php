...
<body>
  <?php 
  $email = $password = $password2 = $fname  = $gender  = $uname = $phone = "";
  ...
  if ($_SERVER["REQUEST_METHOD"] === "POST" && prepare($_POST["formtype"])==="signup"){
    ...
    if ($flag1 === 1 && $flag2 === 1  && $flag3 ===1 && $flag4 === 1 && $flag5 === 1 && $flag6 === 1 && $flag7 === 1){
      ...
      if ($flag1 ===1 && $flag2===1){
        ...
        $sql = "INSERT INTO userinfo (email, name, username , phone , gender ,  password)
  ...
  <div class="navbar">
    ...
    <div class="navbar-right">
      <div>
        <input type="text" class="form-control" pattern="/^[a-zA-Z]+([\.-_]*[0-9]*[a-zA-Z]*[0-9]*)*$/"   placeholder="Username" name="usr" value="">
